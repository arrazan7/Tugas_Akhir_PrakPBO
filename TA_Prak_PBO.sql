...
UPDATE tanggal SET saat_ini = TO_DATE('01-01-2023', 'DD-MM-YYYY');
...
no_rekening NUMBER(23,0), nama_bank VARCHAR2(10),
CONSTRAINT UK_rekening_bank UNIQUE (no_rekening) );

CREATE TABLE transaksi_beli (
id_transaksi VARCHAR2(10), username VARCHAR2(20), 
id_properti CHAR(6), tipe_properti VARCHAR2(20), nama_properti VARCHAR2(20),
harga NUMBER(13,0), no_rekening NUMBER(23,0), tanggal_beli DATE,
...
total_harga NUMBER(10,0), no_rekening NUMBER(23,0),
...
UPDATE transaksi_sewa SET status = 'BERHENTI', terlambat = telat, total_denda = total WHERE id_transaksi = kode;
...
EXECUTE hitung_denda ('TS00002', 'Tipe Industrial', 'Mesin Bor');
EXECUTE hitung_denda ('TS00003', 'Tipe Rumah', 'Rumah 1');
EXECUTE hitung_denda ('TS00004', 'Tipe Rumah', 'Rumah 2');
EXECUTE hitung_denda ('TS00005', 'Tipe Industrial', 'Mesin Bor');
EXECUTE hitung_denda ('TS00006', 'Tipe Industrial', 'Gudang');
